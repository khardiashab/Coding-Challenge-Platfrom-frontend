...
import { DBProblem, ProblemDescription as Problem } from "@/utils/types/types";
...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({
  ...
  const handleLike = async () => {
    ...
    // FIXME UPDATE THE LIKE FUCTIONALITY FROM THE DB.
  ...
  const handleDislike = async () => {
    ...
    // FIXME UPDATE THE DISLIKE FUCTIONALITY FROM THE DB.
...
function useGetCurrentProblem(problemId: string) {
  ...
  useEffect(() => {
    ...
    const getCurrentProblem = async () => {
      ...
      // FIXME GETTING THE PROBLEM FROM THE BACKEND.
...
function useGetUsersDataOnProblem(problemId: string) {
  ...
  useEffect(() => {
    const getUsersDataOnProblem = async () => {
      // FIXME GETTING DETAILS OF THE PROBLEM LIKE LIKED DISLIKED STARRED OR STATUS
      // // const userRef = doc(firestore, "users", user!.uid);
